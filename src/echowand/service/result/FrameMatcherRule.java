 ...
 * @author ymakino
 */
public class FrameMatcherRule implements FrameMatcher {
    private static final Logger LOGGER = Logger.getLogger(FrameMatcherRule.class.getName());
    private static final String CLASS_NAME = FrameMatcherRule.class.getName();
    ...
    public FrameMatcherRule() {
        this.nodes = new ArrayList<Node>();
        this.eojs = new ArrayList<EOJ>();
        this.epcs = new ArrayList<EPC>();
    }
    
    public FrameMatcherRule(Node node, EOJ eoj, EPC epc) {
        LOGGER.entering(CLASS_NAME, "FrameMatcherRule", new Object[]{node, eoj, epc});
        
        init(toList(node), toList(eoj), toList(epc));
        
        LOGGER.exiting(CLASS_NAME, "FrameMatcherRule");
    }
    
    public FrameMatcherRule(List<Node> nodes, EOJ eoj, EPC epc) {
        LOGGER.entering(CLASS_NAME, "FrameMatcherRule", new Object[]{nodes, eoj, epc});
    ...
    public FrameMatcherRule(Node node, EOJ eoj, List<EPC> epcs) {
        LOGGER.entering(CLASS_NAME, "FrameMatcherRule", new Object[]{node, eoj, epcs});
    ...
    public FrameMatcherRule(List<Node> nodes, EOJ eoj, List<EPC> epcs) {
        LOGGER.entering(CLASS_NAME, "FrameMatcherRule", new Object[]{nodes, eoj, epcs});
    ...
    public FrameMatcherRule(Node node, ClassEOJ ceoj, EPC epc) {
        LOGGER.entering(CLASS_NAME, "FrameMatcherRule", new Object[]{node, ceoj, epc});
    ...
    public FrameMatcherRule(List<Node> nodes, ClassEOJ ceoj, EPC epc) {
        LOGGER.entering(CLASS_NAME, "FrameMatcherRule", new Object[]{nodes, ceoj, epc});
    ...
    public FrameMatcherRule(Node node, ClassEOJ ceoj, List<EPC> epcs) {
        LOGGER.entering(CLASS_NAME, "FrameMatcherRule", new Object[]{node, ceoj, epcs});
    ...
    public FrameMatcherRule(List<Node> nodes, ClassEOJ ceoj, List<EPC> epcs) {
        LOGGER.entering(CLASS_NAME, "FrameMatcherRule", new Object[]{nodes, ceoj, epcs});
    ...
    public FrameMatcherRule(List<Node> nodes, List<EOJ> eojs, List<EPC> epcs) {
        LOGGER.entering(CLASS_NAME, "FrameMatcherRule", new Object[]{nodes, eojs, epcs});
    ...
    public String toString() {
        return "FrameMatcherRule{Nodes: " + nodes + ", EOJs: " + eojs + ", EPCs: " + epcs + "}";
    }
}
